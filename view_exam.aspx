<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="view_exam.aspx.cs" Inherits="_Default" %>
...
<ContentTemplate>
<center>
<asp:Label ID="Lbl_Header" Font-Bold="true" Font-Size="Large" runat="server">EXAM LIST (FOR VIEWING)</asp:Label>
<br /><br />
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <ItemTemplate>
        <a href="<%# (string) Check_View_Exam(Eval("Exam_id").ToString())%>">View Exam</a>
        </ItemTemplate>
        </asp:TemplateField>
