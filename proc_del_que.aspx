<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="proc_del_que.aspx.cs" Inherits="_Default" %>
...
<br /><br />
 ...
 <asp:Label ID="Lbl_Heading" runat="server"><h2>DELETING QUESTION</h2></asp:Label><br>
 </asp:TableCell>
 </asp:TableRow>
 <asp:TableRow>
...
<asp:TextBox ID="Txt_opt_e" runat="server" dir="rtl" Width="97%" Height="40" TextMode="MultiLine" Enabled="false"></asp:TextBox>
 ...
 <asp:Button ID="btn_del_que" runat="server" ValidationGroup="Validation_qb_Group" Text="Delete" OnClick="btn_del_que_Click" OnClientClick="return delete_cont('exam');"/>&nbsp;&nbsp;
