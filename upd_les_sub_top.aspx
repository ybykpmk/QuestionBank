<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="upd_les_sub_top.aspx.cs" Inherits="_Default" %>
...
<ContentTemplate>
<center>
<asp:Label ID="Lbl_Header" Font-Bold="true" Font-Size="Large" runat="server">LESSON SUB-TOPIC LIST (FOR UPDATING)</asp:Label>
<br /><br />
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <ItemTemplate>
        <a href="<%# (string) Check_Update_Lesson_Sub_Topic(Eval("Lesson_sub_topic_id").ToString())%>">Update Lesson Sub-Topic</a>
        </ItemTemplate>
        </asp:TemplateField>
