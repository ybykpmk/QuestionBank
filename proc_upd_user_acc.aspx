<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="proc_upd_user_acc.aspx.cs" Inherits="_Default" %>
...
<br />
 <asp:Table ID="Table_Upd_User" runat="server" Width="100%" HorizontalAlign="Center">
 <asp:TableRow>
 <asp:TableCell ColumnSpan="6" HorizontalAlign="Center">
 <asp:Label ID="Lbl_Heading" runat="server"><h2>UPDATING USER ACCOUNT</h2></asp:Label>
 </asp:TableCell>
 </asp:TableRow>
 <asp:TableRow>
 ...
 <asp:Label ID="Lbl_rank" runat="server">Rank : </asp:Label>
   ...
   <asp:TableCell>
  <asp:DropDownList ID="DDL_rank" dir="rtl" runat="server"></asp:DropDownList>
...
<asp:ListBox ID="LB_userauthority" runat="server" SelectionMode="Multiple" Width="230"></asp:ListBox>
 ...
 <asp:RequiredFieldValidator ID="txt_conf_passwordRequired" runat="server" ControlToValidate="txt_conf_password" 
...
<asp:CompareValidator ID="CompareNewPassword" runat="server" ControlToCompare="txt_password" ControlToValidate="txt_conf_password" 
 ...
 <asp:TableRow>
 <asp:TableCell ColumnSpan="6" HorizontalAlign="Center">
 <asp:Button ID="btn_upd_user" runat="server" ValidationGroup="Validation_qb_Group" Text="Update" OnClick="btn_upd_user_Click"/>&nbsp;&nbsp;
