...
public partial class _Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["User"] != null)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    Lbl_record_stat.Text = "<font color='red'>Deleting Question has been Canceled.</font>";
                }
                else if (Request.QueryString["process"] == "question_deleted")
                {
                    Lbl_record_stat.Text = "<font color='navy'>Question has been Deleted.</font>";
                }
                else if (Request.QueryString["process"] == "question_asked_in_exam")
                {
                    Lbl_record_stat.Text = "<font color='red'>This Question has been Asked in " + Request.QueryString["que_count"] + " exam(s). If you want to delete this question, you must replace it with another question in exam(s).</font>";
                }
    ...
    public string Check_Delete_Question(string pi_question_id)
    {
        string myurl = "proc_del_que.aspx?pi_question_id=" + pi_question_id;
        return myurl;
    }
