...
namespace Ybyk.QBank.Bll
{
    ...
    /// </summary>
    [DataObjectAttribute()]
    public class Exam_Question_TemplateManager
    {
        ...
        public static Exam_Question_TemplateList GetList(Int32 pi_exam_template_id)
        {
            ...
            return Exam_Question_TemplateDB.GetList(pi_exam_template_id);
        }
        ...
        {
            //şimdilik herkes seçebilir
            Exam_Question_Template myExam_Question_Template = Exam_Question_TemplateDB.GetItem(pi_exam_question_template_id);
        ...
        {
            //şimdilik herkes seçebilir
            Int32 rec_count = Exam_Question_TemplateDB.AskQuestion_Order_In_Exam_Group(pi_exam_id, pi_exam_group_id, pi_exam_question_order);
            return rec_count;
        }
        ...
        {
            Int32 rows = Exam_Question_TemplateDB.Insert(myExam_Question_Template);
        ...
        {
            Int32 rows = Exam_Question_TemplateDB.Update(myExam_Question_Template);
        ...
        {
            return Exam_Question_TemplateDB.Delete(pi_exam_question_template_id);
        }
