...
public partial class _Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["User"] != null)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    Lbl_record_stat.Text = "<font color='red'>Deleting Lesson Sub-Topic has been Canceled.</font>";
                }
                else if (Request.QueryString["process"] == "lesson_sub_topic_deleted")
                {
                    Lbl_record_stat.Text = "<font color='navy'>Lesson Sub-Topic has been Deleted.</font>";
                }
                else if (Request.QueryString["process"] == "exams_about_les_sub_top")
                {
                    Lbl_record_stat.Text = "<font color='red'>There is (are) " + Request.QueryString["exam_count"] + " exam(s) about lesson which includes lesson subject that includes this lesson sub_topic. If you want to delete this lesson sub_topic, you must delete exam(s) which is(are) about the lesson includes this lesson sub_topic or delete question(s) about this lesson sub_topic in exams.</font>";
                }
    ...
    public string Check_Delete_Lesson_Sub_Topic(string pi_lesson_sub_topic_id)
    {
        string myurl = "proc_del_les_sub_top.aspx?pi_lesson_sub_topic_id=" + pi_lesson_sub_topic_id;
        return myurl;
    }
