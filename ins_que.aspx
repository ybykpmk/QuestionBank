<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ins_que.aspx.cs" Inherits="_Default" %>
...
<br /><br />
 ...
 <asp:Label ID="Lbl_Heading" runat="server"><h2>CREATING QUESTION</h2></asp:Label><br>
 </asp:TableCell>
 </asp:TableRow>
 <asp:TableRow>
 ...
 <asp:TextBox ID="Txt_que" runat="server" Height="80" dir="rtl" Width="99%" TextMode="MultiLine" MaxLength="500"></asp:TextBox>
...
<asp:RequiredFieldValidator ID="Txt_opt_eRequired" runat="server" ControlToValidate="Txt_opt_e" 
 ...
 <asp:Button ID="btn_rec_que" runat="server" ValidationGroup="Validation_qb_Group" Text="Record" OnClick="btn_rec_que_Click"/>&nbsp;&nbsp;
