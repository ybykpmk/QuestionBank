<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="upd_exam.aspx.cs" Inherits="_Default" %>
...
<ContentTemplate>
<center>
<asp:Label ID="Lbl_Header" Font-Bold="true" Font-Size="Large" runat="server">EXAM LIST (FOR UPDATING)</asp:Label>
<br /><br />
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <ItemTemplate>
        <asp:Label ID="Label1" runat="server"><%# (string) Check_Update_Exam(Eval("Exam_id").ToString())%></asp:Label>
        </ItemTemplate>
        </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        SelectMethod="GetList_For_Department" TypeName="Ybyk.QBank.Bll.ExamManager" 
