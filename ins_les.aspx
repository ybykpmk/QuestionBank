<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ins_les.aspx.cs" Inherits="_Default" %>
...
<br /><br />
 ...
 <asp:Label ID="Lbl_Heading" runat="server"><h2>CREATING LESSON</h2></asp:Label><br>
 </asp:TableCell>
 </asp:TableRow>
 <asp:TableRow>
 ...
 <asp:Label ID="Lbl_les_name" runat="server">Lesson Name : </asp:Label>
   ...
   <asp:TableCell>
 <asp:TextBox ID="Txt_les_name" runat="server" dir="rtl" Width="280" MaxLength="50"></asp:TextBox>
 ...
 <asp:Button ID="btn_rec_les" runat="server" ValidationGroup="Validation_qb_Group" Text="Record" OnClick="btn_rec_les_Click"/>&nbsp;&nbsp;
