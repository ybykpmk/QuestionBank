<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="pub_exam.aspx.cs" Inherits="_Default" %>
...
<ContentTemplate>
<center>
<asp:Label ID="Lbl_Header" Font-Bold="true" Font-Size="Large" runat="server">EXAM LIST (FOR PUBLISHING)</asp:Label>
<br /><br />
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <ItemTemplate>
        <asp:Label runat="server"><%# (string) Check_Exam(Eval("Exam_id").ToString())%></asp:Label>
        </ItemTemplate>
        </asp:TemplateField>
