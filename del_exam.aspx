<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="del_exam.aspx.cs" Inherits="_Default" %>
...
<ContentTemplate>
<center>
<asp:Label ID="Lbl_Header" Font-Bold="true" Font-Size="Large" runat="server">EXAM LIST (FOR DELETING)</asp:Label>
<br /><br />
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <ItemTemplate>
        <asp:Label ID="Label1" runat="server"><%# (string) Check_Delete_Exam(Eval("Exam_id").ToString())%></asp:Label>
        </ItemTemplate>
        </asp:TemplateField>
