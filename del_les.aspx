<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="del_les.aspx.cs" Inherits="_Default" %>
...
<ContentTemplate>
<center>
<asp:Label ID="Lbl_Header" Font-Bold="true" Font-Size="Large" runat="server">LESSON LIST (FOR DELETING)</asp:Label>
<br /><br />
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <ItemTemplate>
        <a href="<%# (string) Check_Delete_Lesson(Eval("Lesson_id").ToString())%>">Delete Lesson</a>
        </ItemTemplate>
        </asp:TemplateField>
