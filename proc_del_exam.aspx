<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="proc_del_exam.aspx.cs" Inherits="_Default" %>
...
<br /><br />
 ...
 <asp:Label ID="Lbl_Heading" runat="server"><h2>DELETING EXAM</h2></asp:Label><br>
 </asp:TableCell>
 </asp:TableRow>
 <asp:TableRow>
...
<asp:TableCell ColumnSpan="4" HorizontalAlign="Center">
 ...
 <asp:Button ID="btn_del_exam" runat="server" Text="Delete Exam" OnClick="btn_del_exam_Click" OnClientClick="return delete_cont('exam');"/>
</asp:TableCell>
</asp:TableRow>
</asp:Table>
</asp:Content>